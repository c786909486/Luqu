package com.example.vuandroidadsdk.glideLoader;
...
import com.example.vuandroidadsdk.glideLoader.progress.OnProgressListener;
import com.example.vuandroidadsdk.glideLoader.progress.ProgressManager;
import com.example.vuandroidadsdk.glideLoader.transformation.GlideCircleTransformation;
...
public class GlideImageLoader { private static final String ANDROID_RESOURCE = "android.resource://";
    ...
    public void load(String url, RequestOptions options, final OnBitmapReadyListener listener){
        if (url == null || getContext() == null) return;
        requestBitmapBuilder(url,options).into(new SimpleTarget<Bitmap>() {
            @Override
    ...
    public void loadGif(String url, RequestOptions options){
        if (url == null || getContext() == null) return;
        requestGifBuilder(url,options).into(getImageView());
    }
    ...
    public RequestBuilder<Bitmap> requestBitmapBuilder(Object obj, RequestOptions options) {
        this.mImageUrlObj = obj;
        return Glide.with(getContext())
                .asBitmap()
                .load(obj)
    ...
    public RequestBuilder<GifDrawable> requestGifBuilder(Object obj, RequestOptions options) {
        this.mImageUrlObj = obj;
        return Glide.with(getContext())
                .asGif()
                .load(obj)
    ...
    public GlideImageLoader loadImage(String url, int placeholderResId) {
        load(url, requestOptions(placeholderResId));
        return this;
    }
    public GlideImageLoader loadImageWithListener(String url,int placeholderResId,OnBitmapReadyListener listener){
        load(url,requestOptions(placeholderResId),listener);
        return this;
    }
    public GlideImageLoader loadeGif(String url,int placeholderResId){
        loadGif(url,requestOptions(placeholderResId));
        return this;
    }
